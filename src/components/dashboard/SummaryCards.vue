...
<style scoped>
  .summary_card_success{
    background: linear-gradient(to bottom right, #9C27B0 0%, #009900 100%);
  }
  .summary_card_failure{
    background: linear-gradient(to bottom right, #9C27B0 0%, red 100%);
  }
</style>
